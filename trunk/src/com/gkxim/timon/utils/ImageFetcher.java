...
public class ImageFetcher extends ImageWorker {
    ...
    private Bitmap processBitmap(String key, int type) {
        MyLogger.l(1, TAG + "=> processBitmap - " + key);
        ...
        synchronized (mHttpDiskCacheLock) {
            ...
            if (mHttpDiskCache != null) {
                try {
                    ...
                    if (snapshot == null) {
                        MyLogger.l(1, TAG + "=> processBitmap, not found in http cache, downloading...");
                    ...
                    MyLogger.l(4, TAG + "=> processBitmap - " + e);
    ...
    public static byte[] downloadBitmapToMemory(String urlString, int maxBytes) {
        MyLogger.l(1, TAG + "=> downloadBitmapToMemory - downloading - " + urlString);
        ...
        try {
            ...
            MyLogger.l(4, TAG + "=> Error in downloadBitmapToMemory - " + e);
        } finally {
    ...
    public boolean downloadUrlToStream(String urlString, OutputStream outputStream) {
        ...
        try {
            ...
            MyLogger.l(4, TAG + "=> Error in downloadBitmap - " + e);
        } finally {
            if (urlConnection != null) {
                urlConnection.disconnect();
            }
    ...
    public static File downloadBitmapToFile(String urlString, File cacheDir) {
        MyLogger.l(1, TAG + "=> downloadBitmap - downloading - " + urlString);
        ...
        synchronized (mHttpDiskCacheLock) {
            if (ImageCache.getUsableSpace(mHttpCacheDir) > HTTP_CACHE_SIZE) {
                try {
                    ...
                    MyLogger.l(1, TAG + "=> HTTP cache initialized");
                } catch (IOException e) {
                    mHttpDiskCache = null;
                }
            }
        ...
        synchronized (mHttpDiskCacheLock) {
            if (mHttpDiskCache != null && !mHttpDiskCache.isClosed()) {
                try {
                    ...
                    MyLogger.l(1, TAG + "=> HTTP cache cleared");
                } catch (IOException e) {
                    MyLogger.l(4, TAG + "=> clearCacheInternal - " + e);
                }
                mHttpDiskCache = null;
        ...
        synchronized (mHttpDiskCacheLock) {
            if (mHttpDiskCache != null) {
                try {
                    ...
                    MyLogger.l(1, TAG + "=> HTTP cache flushed");
                } catch (IOException e) {
                    MyLogger.l(4, TAG + "=> flush - " + e);
                }
            }
        }
    }
            ...
            if (mHttpDiskCache != null) {
                try {
                    if (!mHttpDiskCache.isClosed()) {
                        ...
                        mHttpDiskCache = null;
                        MyLogger.l(1, TAG + "=> HTTP cache closed");
                    }
                } catch (IOException e) {
                    MyLogger.l(4, TAG + "=> closeCacheInternal - " + e);
                }
            }
        }
    }
