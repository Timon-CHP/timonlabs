...
public class ImageCache {
    ...
    private void init(ImageCacheParams cacheParams) {
        ...
        if (mCacheParams.memoryCacheEnabled) {
            MyLogger.l(0, TAG + "=> Memory cache created (size = " + mCacheParams.memCacheSize + ")");
                ...
                if (mCacheParams.diskCacheEnabled && diskCacheDir != null) {
                    ...
                    if (getUsableSpace(diskCacheDir) > mCacheParams.diskCacheSize) {
                        try {
                            ...
                            MyLogger.l(0, TAG + "=> Disk cache initialized");
                        } catch (final IOException e) {
                            mCacheParams.diskCacheDir = null;
                            MyLogger.l(4, TAG + "=> initDiskCache - " + e);
                        }
                    }
                }
            }
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
                ...
                try {
                	...
                	MyLogger.l(4, TAG + "=> addBitmapToCache - " + e);
                } catch (Exception e) {
                	MyLogger.l(4, TAG + "=> addBitmapToCache - " + e);
                } finally {
                    try {
    ...
    public Bitmap getBitmapFromMemCache(String data) {
        if (mMemoryCache != null) {
            ...
            if (memBitmap != null) {
            	MyLogger.l(1, TAG + "=> Memory cache hit");
                return memBitmap;
            }
        }
        return null;
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
                ...
                try {
                    ...
                    if (snapshot != null) {
                    	MyLogger.l(1, TAG + "=> Disk cache hit");
                	...
                	MyLogger.l(4, TAG + "=> getBitmapFromDiskCache - " + e);
                } finally {
                    try {
                        if (inputStream != null) {
                            inputStream.close();
    ...
    public void clearCache() {
        if (mMemoryCache != null) {
            ...
            MyLogger.l(1, TAG + "=> Memory cache cleared");
        }
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null && !mDiskLruCache.isClosed()) {
                try {
                    ...
                    MyLogger.l(1, TAG + "=> Disk cache cleared");
                } catch (IOException e) {
                	MyLogger.l(4, TAG + "=> clearCache - " + e);
                }
                mDiskLruCache = null;
                initDiskCache();
            }
    ...
    public void flush() {
        synchronized (mDiskCacheLock) {
            if (mDiskLruCache != null) {
                try {
                    mDiskLruCache.flush();
                    MyLogger.l(1, TAG + "=> Disk cache flushed");
                } catch (IOException e) {
            ...
            if (mDiskLruCache != null) {
                try {
                    if (!mDiskLruCache.isClosed()) {
                        mDiskLruCache.close();
                        mDiskLruCache = null;
                        MyLogger.l(1, TAG + "=> Disk cache closed");
                    }
                } catch (IOException e) {
                	MyLogger.l(4, TAG + "=> close - " + e);
                }
            }
        }
    }
