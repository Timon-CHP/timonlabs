...
public abstract class ImageWorker {
    ...
    private static final boolean DEBUG = MyLogger.DEBUG_ON;
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, "AsyncTask_ImageWorker#" + mCount.getAndIncrement());
        }
    };
    ...
    public static void cancelWork(ImageView imageView) {
        ...
        if (bitmapWorkerTask != null) {
            ...
            if (DEBUG) {
                MyLogger.l(1, TAG + "=> cancelWork - cancelled work for " + bitmapWorkerTask.data);
            }
        }
    }
    ...
    public static boolean cancelPotentialWork(Object data, ImageView imageView) {
        ...
        if (bitmapWorkerTask != null) {
            ...
            if (bitmapData == null || !bitmapData.equals(data)) {
                bitmapWorkerTask.cancel(true);
                MyLogger.l(1, TAG + "=> cancelPotentialWork - cancelled work for " + data);
            } else {
    ...
    private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Object... params) {
            MyLogger.l(1, TAG + "=> doInBackground - starting work");
            ...
            MyLogger.l(1, TAG + "=> doInBackground - finished work");
            return bitmap;
        }
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            if (bitmap != null && imageView != null) {
                MyLogger.l(1, TAG + "=> onPostExecute - setting bitmap");
